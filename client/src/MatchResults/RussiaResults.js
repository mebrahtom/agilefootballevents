...
class RussiaResults extends Component{
...
function renderMatchRows(resultmatches){
  ...
  if(resultmatches[i].team1==='RUS' ||resultmatches[i].team2==='RUS'){
...
export default connect(mapStateToProps, mapDispatchToProps)(RussiaResults)
