...
class AustraliaResults extends Component{
...
function renderMatchRows(resultmatches){
  ...
  if(resultmatches[i].team1==='AUS' ||resultmatches[i].team2==='AUS'){
...
export default connect(mapStateToProps, mapDispatchToProps)(AustraliaResults)
