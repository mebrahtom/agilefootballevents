...
class SpainResults extends Component{
...
function renderMatchRows(resultmatches){
  ...
  if(resultmatches[i].team1==='SPA' ||resultmatches[i].team2==='SPA'){
...
export default connect(mapStateToProps, mapDispatchToProps)(SpainResults)
