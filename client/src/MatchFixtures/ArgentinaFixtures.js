...
class ArgentinaFixtures extends Component{
...
function renderMatchRows(upcomingmatches){
  ...
  for(var i = 0; i < upcomingmatches.length; i++ ){
    if(upcomingmatches[i].team1==='ARG' ||upcomingmatches[i].team2==='ARG'){
...
export default connect(mapStateToProps, mapDispatchToProps)(ArgentinaFixtures)
