...
class SwedenFixtures extends Component{
...
function renderMatchRows(upcomingmatches){
  ...
  for(var i = 0; i < upcomingmatches.length; i++ ){
    if(upcomingmatches[i].team1==='SWE' ||upcomingmatches[i].team2==='SWE'){
...
export default connect(mapStateToProps, mapDispatchToProps)(SwedenFixtures)
