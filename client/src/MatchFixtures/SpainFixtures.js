...
class SpainFixtures extends Component{
...
function renderMatchRows(upcomingmatches){
  ...
  for(var i = 0; i < upcomingmatches.length; i++ ){
    if(upcomingmatches[i].team1==='SPA' ||upcomingmatches[i].team2==='SPA'){
...
export default connect(mapStateToProps, mapDispatchToProps)(SpainFixtures)
