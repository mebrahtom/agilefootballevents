...
class AustraliaFixtures extends Component{
...
function renderMatchRows(upcomingmatches){
  ...
  for(var i = 0; i < upcomingmatches.length; i++ ){
    if(upcomingmatches[i].team1==='AUS' ||upcomingmatches[i].team2==='AUS'){
...
export default connect(mapStateToProps, mapDispatchToProps)(AustraliaFixtures)
